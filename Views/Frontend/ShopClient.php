...
session_start();
$prodC = new ProduitC();
$listproduits=$prodC->AfficherParCateg($_GET['id']);
if(isset($_REQUEST['submit-search']))
      {
       $listproduits = $prodC->Recherche($_GET['id'],$_POST['search']);
      }else {
        $listproduits=$prodC->AfficherParCateg($_GET['id']);
      }
...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <form action="" method="POST" class="modal-content modal-body border-0 p-0">
                <div class="input-group mb-2">
                    ...
                    <button type="submit" name="submit-search" class="input-group-text bg-success text-light">
    ...
    <div class="container py-5">
                ...
                <div class="row">
                    <!-- Starts here -->
                    <?php foreach($listproduits as $key) { ?>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none"><?php echo $key['nom']?></a>
